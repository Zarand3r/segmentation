...
cv2.imwrite("output/segment/1.jpg", res2)  # Write image onto disk
...
# Display image
cv2.imwrite("output/segment/2.jpg", meanshift)
...
cv2.imwrite("output/segment/3.jpg", final)  # Write the image
